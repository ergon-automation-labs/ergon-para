defmodule BotArmyPara.Skills.Example do
  @moduledoc """
  Example skill for Para Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_para.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_para.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_para/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_para.command.example"
    ]
  end
