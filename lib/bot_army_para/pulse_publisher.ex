defmodule BotArmyPara.PulsePublisher do
  @moduledoc """
  Periodic health publisher for Para Bot.
  ...
  2. **`bot.para.pulse`** — richer metrics every 30 minutes (lower NATS volume).
  ...
  @impl true
  def init(_opts) do
    Logger.info("[PulsePublisher] Starting Para Bot pulse publisher")
